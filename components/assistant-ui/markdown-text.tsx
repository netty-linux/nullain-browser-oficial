...
const defaultComponents = memoizeMarkdownComponents({
  h1: ({ className, ...props }) => (
    <h1
      className={cn(
        "aui-md-h1 mt-7 mb-3 scroll-m-20 text-[1.55rem] font-semibold tracking-[-0.025em] first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={cn(
        "aui-md-h2 mt-6 mb-2.5 scroll-m-20 text-[1.3rem] font-semibold tracking-[-0.02em] first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }) => (
    <h3
      className={cn(
        "aui-md-h3 mt-5 mb-2 scroll-m-20 text-[1.08rem] font-semibold first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  p: ({ className, ...props }) => (
    <p className={cn("aui-md-p my-3.5 leading-7 first:mt-0 last:mb-0", className)} {...props} />
  ),
  a: ({ className, ...props }) => (
    <a
      className={cn(
  ...
  ul: ({ className, ...props }) => (
    <ul
      className={cn(
        "aui-md-ul marker:text-muted-foreground my-3.5 ms-5 list-disc [&>li]:mt-1.5",
        className,
      )}
      {...props}
    />
  ...
  ol: ({ className, ...props }) => (
    <ol
      className={cn(
        "aui-md-ol marker:text-muted-foreground my-3.5 ms-5 list-decimal [&>li]:mt-1.5",
        className,
      )}
      {...props}
    />
  ...
  table: ({ className, ...props }) => (
    <div className="my-3 w-full overflow-x-auto rounded-lg border border-border/50">
      <table
        className={cn(
          "aui-md-table w-full min-w-[640px] border-separate border-spacing-0",
          className,
        )}
        {...props}
      />
